...
int main()
{
   ...
   if (dfSideA <= 0)
    {
        cout << "INVALID SIDE ENTERED. PROGRAM IS TERMINATING." << endl;
   ...
   if (dfSideC <= 0)
    ...
    //***
    //*** Calculate whether the triangle is valid or not
    //***

 if ((dfSideA+dfSideB<=dfSideC)||(dfSideA+dfSideC<=dfSideB)||(dfSideB+dfSideC<=dfSideA))
    {
        cout << "\n*** SIDES DO NOT FORM A TRIANGLE."<< endl;
  ...
  dfArea = sqrt(dfS*(dfS-dfSideA)*(dfS-dfSideB)*(dfS-dfSideC));
    ...
    //***
    cout << endl;
    cout<<"Area: "<<fixed<<setprecision(2)<<right<< setw(50)<< dfArea << endl;
    cout<< "Perimeter: "<<fixed<<setprecision(2)<<right<< setw(45)<<dfPerimeter << endl << endl;
